...
#
# Usage:
#   bash scripts/core/hardening/ssh-key-rotate.sh --show
#   bash scripts/core/hardening/ssh-key-rotate.sh --add-key "ssh-ed25519 AAAA... comment"
#   bash scripts/core/hardening/ssh-key-rotate.sh --add-key "ssh-ed25519 AAAA..." --remove-line 2
#   bash scripts/core/hardening/ssh-key-rotate.sh --user myuser --add-key "ssh-ed25519 AAAA..."
set -euo pipefail
