#!/usr/bin/env bash
# 13-apache-dos-mitigation.sh — mod_reqtimeout (Slowloris) and mod_evasive (HTTP flood)
#
...
# vps-security: mod_reqtimeout — Slowloris mitigation
...
# vps-security: mod_evasive — HTTP flood rate limiting
# Managed by 13-apache-dos-mitigation.sh
