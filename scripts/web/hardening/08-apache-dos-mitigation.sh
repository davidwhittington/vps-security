...
for arg in "$@"; do
    ...
    if [[ "$arg" == "--help" || "$arg" == "-h" ]]; then
        echo "08-apache-dos-mitigation.sh — configure mod_evasive and mod_reqtimeout for DoS mitigation"
        echo
        echo "Usage:"
        echo "  bash scripts/web/hardening/08-apache-dos-mitigation.sh [--dry-run] [--confirm]"
        echo
        echo "Flags:"
